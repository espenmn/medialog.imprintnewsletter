                     ...
                     <table
                        ...
                        <tr style="text-align: left">
                            <td   style="text-align: left; padding:20px; ">
                                ...
                                <div style="color: #555; background-color: #ffffff; padding: 14px 0; margin: 14px 0 0;">
        ...
        for obj in items:
            ...
            <tr style="text-align:left">
                ...
                <h3 style="color: #DB002F ; margin-top: 14px; margin: 14px 0 7px 0; line-height: 1.2; font-size: 30px; font-weight: 300;">
                    <a href="{obj.absolute_url()}" style="text-decoration: none !important; color: #DB002F ;">{obj.Title()}</a>
                </h3>
            ...
            html_output += f"""   
                <a href="{obj.absolute_url()}"
                   ...
                   border: 1px solid  #DB002F; padding: 8px 14px; 
                   font-size: 15px; 
                   text-decoration: none !important;
                   display: inline-block;
                   border-radius: 5px">Lees verder</a>
                </td>
            </tr>
